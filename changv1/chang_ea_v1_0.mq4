...
//--- create timer
   ...
   txt_set=StringFormat("setP : %.2f set_cutloss : %.2f set_tp %.2f ",setP,set_cutloss,set_tp);
    yai_tool1.LineNotify(_token,"EA Ready.......");
...
//---
      ...
      if(yai_tool1.Ck_candle()){
         ...
         yai_tool1.LineNotify(_token,txt_daily);
...
void open_order(double &open_p){
   if(order_type ==0){
            ...
            if(sig_b!=0&&Close[0]>=sig_b ){
                     ...
                     yai_tool1.LineNotify(_token,"Buy Symbol:"+Symbol()+" At Price"+DoubleToString(Ask,2));
                  ...
                  Print("Open Buy At",open_p);
                           ...
                           open_p = Bid;
                              ...
                              yai_tool1.LineNotify(_token,"Sell Symbol:"+Symbol()+" At Price"+DoubleToString(Bid,2));
   ...
   if(order_type==1){
      if(Close[0]<=cutloss){
            ...
            if(OrdersTotal()>0){
               ...
               yai_tool1.LineNotify(_token,"Close Symbol:"+Symbol()+" At Price"+DoubleToString(Bid,2));
            }
            printf("Oder buy Close at %.2f orderbuy sig_b = %.2f sig_s =%.2f",Close[0],sig_b,sig_s);
               ...
               if(Close[0]>=cutloss){
                  ...
                  if(OrdersTotal()>0){
                   ...
                   yai_tool1.LineNotify(_token,"Close Symbol:"+Symbol()+" At Price"+DoubleToString(Ask,2));
            }
        }
